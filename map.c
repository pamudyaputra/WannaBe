...
char guide[25][93] = {
	...
	"|                                                                                          |",
    "| 1. Standard calculator, perform standard calculation                                     |",
	"|                                                                                          |",
	...
	"|                                                                                          |",
	"| 4. Guide, to find out how to use CALCO application and to find out what are the guides   |",
...
char calStdGuide[24][94] = {	
	...
	"<==========================================================================================>",
 	...
 	"|                                                                                          |",
 	"| 1. If you write an unary expression, especially with the negation operator (-),          |",
	...
	"|    '(' and ')' for parenthesizing an operation.                                          |",
